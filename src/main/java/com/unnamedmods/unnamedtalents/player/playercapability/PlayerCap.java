...
public class PlayerCap implements IPlayerCap
{
    ...
    private int skillCategoryXPThreshold;
    ...
    @Override
    public int getSkillCategoryXPMax()
    {
        return this.skillCategoryXPThreshold;
    }
    ...
    public void setAttackXP(int attackXP)
    {
        ...
        if (this.attackXP >= (this.XPThreshold * this.attackLevel))
        {
            this.attackXP = (this.attackXP - (this.XPThreshold * this.attackLevel));
            this.attackLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setDefenseXP(int defenseXP)
    {
        ...
        if (this.defenseXP >= (this.XPThreshold * this.defenseLevel))
        {
            this.defenseXP = (this.defenseXP - (this.XPThreshold * this.defenseLevel));
            this.defenseLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setArcheryXP(int archeryXP)
    {
        ...
        if (this.archeryXP >= (this.XPThreshold * this.archeryLevel))
        {
            this.archeryXP = (this.archeryXP - (this.XPThreshold * this.archeryLevel));
            this.archeryLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setSmeltingXP(int smeltingXP)
    {
        ...
        if (this.smeltingXP >= (this.XPThreshold * this.smeltingLevel))
        {
            this.smeltingXP = (this.smeltingXP - (this.XPThreshold * this.smeltingLevel));
            this.smeltingLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setForagingXP(int foragingXP)
    {
        ...
        if (this.foragingXP >= (this.XPThreshold * this.foragingLevel))
        {
            this.foragingXP = (this.foragingXP - (this.XPThreshold * this.foragingLevel));
            this.foragingLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setFarmingXP(int farmingXP)
    {
        ...
        if (this.farmingXP >= (this.XPThreshold * this.farmingLevel))
        {
            this.farmingXP = (this.farmingXP - (this.XPThreshold * this.farmingLevel));
            this.farmingLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setAlchemyXP(int alchemyXP)
    {
        ...
        if (this.alchemyXP >= (this.XPThreshold * this.alchemyLevel))
        {
            this.alchemyXP = (this.alchemyXP - (this.XPThreshold * this.alchemyLevel));
            this.alchemyLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setAgilityXP(int agilityXP)
    {
        ...
        if (this.agilityXP >= (this.XPThreshold * this.agilityLevel))
        {
            this.agilityXP = (this.agilityXP - (this.XPThreshold * this.agilityLevel));
            this.agilityLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setEnchantingXP(int enchantingXP)
    {
        ...
        if (this.enchantingXP >= (this.XPThreshold * this.enchantingLevel))
        {
            this.enchantingXP = (this.enchantingXP - (this.XPThreshold * this.enchantingLevel));
            this.enchantingLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setMiningXP(int miningXP)
    {
        ...
        if (this.miningXP >= (this.XPThreshold * this.miningLevel))
        {
            this.miningXP = (this.miningXP - (this.XPThreshold * this.miningLevel));
            this.miningLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setExcavationXP(int excavationXP)
    {
        ...
        if (this.excavationXP >= (this.XPThreshold * this.excavationLevel))
        {
            this.excavationXP = (this.excavationXP - (this.XPThreshold * this.excavationLevel));
            this.excavationLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
    ...
    public void setBuildingXP(int buildingXP)
    {
        ...
        if (this.buildingXP >= (this.XPThreshold * this.buildingLevel))
        {
            this.buildingXP = (this.buildingXP - (this.XPThreshold * this.buildingLevel));
            this.buildingLevel += levelGain;
            this.skillPoints += childSkillPointGain;
        }
    }
